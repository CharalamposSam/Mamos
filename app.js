const sections = document.querySelectorAll( 'section' ),
      ...
      sec3_cont1_petros_secret = document.querySelector( '.section3 .cont1 .petros-secret img' ),
...
function initialize_Upadate() {
    ...
    if ( window.innerWidth < 600 || isMobile ) {
        sec3_cont1_petros_secret.src = `images/Section3/Petsos-secret-likiskos.png`
        Sec3_cont1_changeImage = true
    } 

    if ( window.innerWidth > 600 && !isMobile && Sec3_cont1_changeImage ) {
        sec3_cont1_petros_secret.src = `images/Section3/Petros-secret.png`
    }
