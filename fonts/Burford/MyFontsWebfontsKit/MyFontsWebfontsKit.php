...
/*
Plugin Name: MyFontsWebfontsKit #3740081
...
add_action( 'admin_init', array('MyFontsInstaller_3740081','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3740081','mffonts_loadupWebfonts' ));