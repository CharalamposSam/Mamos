...
/*
Plugin Name: MyFontsWebfontsKit #3742687
...
add_action( 'admin_init', array('MyFontsInstaller_3742687','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3742687','mffonts_loadupWebfonts' ));